 /**
 * Rider Scheduled Rides — Converged production view.
 *
 * Full flow wired:
 *   "+" → ScheduleCreateSheet → new ride in list
 *   Hero card → state progression (confirmed → driver-assigned → driver-en-route)
 *   "Track" → navigates to Driver Approach screen
 *   Filters: Upcoming / Recurring / Past (each shows different content)
 *   Tap ride → detail sheet → cancel with confirmation
 */
