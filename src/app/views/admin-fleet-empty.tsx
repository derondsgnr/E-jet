/**
 * FLEET — EMPTY STATE
 * Empty state with explainer + CTA to add fleet owner
 */
    ...
    <div className="w-full h-screen flex flex-col overflow-hidden" style={{ background: t.bg }}>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          >
            <Car size={28} style={{ color: t.iconMuted }} />
          </div>
          ...
          >
            Add fleet owners to grow your driver supply through managed vehicle fleets.
          </p>
          ...
          >
            ...
            <div className="space-y-2 text-left">
              {[
                "You create the fleet owner account",
                "They receive an invitation by email",
                "They add their vehicles and drivers",
                "Vehicles go through inspection",
                "Approved vehicles and drivers go live",
              ].map((step, i) => (
